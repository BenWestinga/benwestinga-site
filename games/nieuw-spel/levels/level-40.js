...
export const config = {
    ...
    spawnGroups: [
        ...
        { enemy: "snowball", count: 10, start: 5, duration: 175},
        { enemy: "snowProtector", count: 4, start: 5, duration: 175},
        { enemy: "snowWorm", count: 7, start: 5, duration: 175},
        { enemy: "snowHealer", count: 5, start: 5, duration: 175},
