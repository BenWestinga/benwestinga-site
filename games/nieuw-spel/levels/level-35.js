...
export const config = {
    ...
    spawnGroups: [
        ...
        { enemy: "snowstorm", count: 1, start: 80, duration: 30},
        { enemy: "snowstorm", count: 1, start: 160, duration: 30},
        { enemy: "snowstorm", count: 1, start: 240, duration: 30},
        { enemy: "snowMan", count: 8, start: 80, duration: 120},
        { enemy: "snowGuy", count: 80, start: 80, duration: 120},
